                ...
                if (S2 && S2.length) {
                    ...
                    if (S2.labelText) {
                        ...
                        if (S2.labelWidth) {
                            ...
                            item.addClass("control-label");
                            var line2 = $("<div></div>").appendTo(line);
                            line2.addClass("controls");
                            //line2.addClass("col-sm-" + (12 - S2.labelWidth));
...
$M.Control["GridView"] = function (BoxID, S) {
    ...
    var focusBlur = function () { foucsObj.dom.html(foucsObj.control.val()); foucsObj.control.remove(); foucsObj.control = null; foucsObj.dom = null; };
